...
/// - Circular progress ring (X/84 discovered)
    ...
    private var achievements: [Achievement] {
        [
            ...
            Achievement(
                ...
                icon: "bolt.fill",
                isUnlocked: discoveredFishIds.contains(34)
            ),
            Achievement(
                title: "Deep Diver",
                description: "Discover a sculpin",
                icon: "arrow.down.circle.fill",
                isUnlocked: discoveredFishIds.contains(74) || discoveredFishIds.contains(75) || discoveredFishIds.contains(76)
            ),
            Achievement(
                title: "Living Fossil",
