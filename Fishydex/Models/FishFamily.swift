...
struct FishFamily: Identifiable, Hashable {
    ...
    /// All 17 Saskatchewan freshwater fish families.
    static let allFamilies: [FishFamily] = [
        ...
        FishFamily(
            id: "cyprinidae",
            name: "Cyprinidae",
            commonName: "Minnows & Carps",
            description: "The largest family of freshwater fish in Saskatchewan. Includes native shiners, daces, and chubs, as well as invasive carps."
        ),
        FishFamily(
            id: "esocidae",
            name: "Esocidae",
