...
///
/// Displays "32 of 60 Discovered (53%)" with an animated fill bar
...
#Preview("Progress Bars") {
    VStack(spacing: 24) {
        PokedexProgressBar(discovered: 0, total: 60)
        PokedexProgressBar(discovered: 32, total: 60)
        PokedexProgressBar(discovered: 60, total: 60)
    }
    .padding()
