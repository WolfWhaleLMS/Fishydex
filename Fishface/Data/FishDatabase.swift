...
/// Central static database assembling all 60 Saskatchewan fish species from 16 family files.
/// All data is compiled into the app — no network required.
enum FishDatabase {

    // MARK: - All Fish (sorted by Pokedex ID)

    /// Complete array of all 60 Saskatchewan fish species, sorted by ID (#001–#060).
    static let allFish: [Fish] = {
        let families: [[Fish]] = [
            ...
            Fish.esocidae,            // Family 4:  Pikes (1)
            Fish.umbridae,            // Family 5:  Mudminnows (1)
            Fish.gadidae,             // Family 6:  Cods (1)
            Fish.gasterosteidae,      // Family 7:  Sticklebacks (2)
            Fish.hiodontidae,         // Family 8:  Mooneyes (2)
            Fish.osmeridae,           // Family 9:  Smelts (1)
            Fish.centrarchidae,       // Family 10: Sunfishes & Basses (6)
            Fish.percidae,            // Family 11: Perches & Darters (8)
            Fish.percopsidae,         // Family 12: Trout-perches (1)
            Fish.salmonidae,          // Family 13: Salmon, Trout & Whitefish (17)
            Fish.cottidae,            // Family 14: Sculpins (3)
            Fish.ictaluridae,         // Family 15: Catfishes (5)
            Fish.sciaenidae,          // Family 16: Drums (1)
    ...
    /// Look up a fish by its Pokedex ID (1–60). Returns nil if ID is out of range.
