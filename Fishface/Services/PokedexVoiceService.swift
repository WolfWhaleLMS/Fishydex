...
final class PokedexVoiceService: NSObject, ObservableObject, AVSpeechSynthesizerDelegate {
    ...
    private func buildDiscoveryScript(_ fish: Fish) -> String {
        ...
        if fish.rarityTier == .mythic {
            parts.append("This is a mythic species. An extraordinary find!")
        } else if fish.rarityTier == .legendary {
            parts.append("This is a legendary species. Remarkable find!")
        } else if fish.rarityTier == .epic {
            parts.append("This is an epic species. Impressive catch!")
