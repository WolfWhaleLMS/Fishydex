...
extension Color {
    ...
    // MARK: Rarity Colors (Fortnite palette)

    /// Common rarity — gray (#8C8C8C)
    static let rarityCommon = Color(red: 0.549, green: 0.549, blue: 0.549)

    /// Uncommon rarity — green (#1EFF00)
    static let rarityUncommon = Color(red: 0.118, green: 1.000, blue: 0.000)

    /// Rare rarity — blue (#4C8BFF)
    static let rarityRare = Color(red: 0.298, green: 0.545, blue: 1.000)

    /// Epic rarity — purple (#BE0CFE)
    static let rarityEpic = Color(red: 0.745, green: 0.047, blue: 0.996)

    /// Legendary rarity — orange (#FF8C00)
    static let rarityLegendary = Color(red: 1.000, green: 0.549, blue: 0.000)

    /// Mythic rarity — gold (#FFD700)
    static let rarityMythic = Color(red: 1.000, green: 0.843, blue: 0.000)
}
